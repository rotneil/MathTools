...
public class PhaseSpace extends JPanel 
	implements MouseListener, MouseMotionListener
{
	// instance variables
	private static double y0 = -2.0;
	private static double yf = 2.0;
	...
	private double eps = 0.150;
	private double u0 = 1.35;
	
	private static JLabel mouseLabel = new JLabel ("");
	int fileCount = 1;
	
	// constructor
	public PhaseSpace (boolean multi, 
	...
	public static void main(String[] args) {
		...
		frame.add(new PhaseSpace (false, x0, xf, y0, yf),
				BorderLayout.CENTER);
