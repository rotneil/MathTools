...
public class HenonManifold extends javax.swing.JFrame
{
	// instance variables
	...
	private double xf = 5.0;
	private double y0 = -2.5;
	private double yf = 5.0;
	
	private double a = -0.75;
	private double b = -1.1;
	private double [] p = new double [] {-1.643717104, -1.643717104};
	private double [] vU = new double [] {1.0, 0.343720354};
	private double [] vS = new double [] {1.0, 2.644856199};
	private double epsilon = 0.000001;
	
	private int nStable = 10000000;
	private int nUnstable = 10000000;
	
	// constructor
	public HenonManifold ()
	{
		// create the frame
		initComponents ();
	...
	public static void main (String [] args)
	{
		...
		java.awt.EventQueue.invokeLater(new Runnable () {
			public void run () {
				new HenonManifold ().setVisible(true);
			}
		});
	}
