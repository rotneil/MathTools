...
public class ForcedDampedPhasePlot extends JPanel 
	implements MouseListener, MouseMotionListener
{
	...
	private static double rho = 5.0;
	
	private boolean multi_plot = false;
	
	// constructor
	public ForcedDampedPhasePlot (boolean multi, 
	...
	private double [] f (double [] v, double t)
	{
		...
		// duffing equation
		vv[0] = v[1];
		vv[1] = rho * Math.sin(t) - c * v[1] + v[0] - Math.pow(v[0], 3);
	...
	public static void main(String[] args) {
		...
		JFrame frame = new JFrame (
				"Forced-damped Duffing Oscilator with c = " +
				c + " rho = " + rho);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.add(new ForcedDampedPhasePlot (false, x0, xf, y0, yf),
				BorderLayout.CENTER);
